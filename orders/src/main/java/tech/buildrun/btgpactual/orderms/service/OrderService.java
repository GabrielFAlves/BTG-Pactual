...
public class OrderService {
    ...
    public BigDecimal findTotalOnOrdersByCustomerId(Long customerId) {
        ...
        // Verifica se o resultado ou o valor "total" está presente
        if (response != null && response.getUniqueMappedResult() != null) {
        ...
        // Se não houver resultados, retorna BigDecimal.ZERO ou lança uma exceção personalizada
